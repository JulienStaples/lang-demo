...
export let diffWordColors = `data-[diff=hard]:bg-orange-800 data-[diff=hard]:hover:bg-orange-700 data-[diff=hard]:active:bg-orange-900 data-[diff=med]:bg-yellow-800 data-[diff=med]:hover:bg-yellow-700 data-[diff=med]:active:bg-yellow-900 data-[diff=easy]:bg-green-800 data-[diff=easy]:hover:bg-green-700 data-[diff=easy]:active:bg-green-900 data-[diff=wk]:bg-gray-500 data-[diff=wk]:hover:bg-gray-400 data-[diff=wk]:active:bg-gray-600`
